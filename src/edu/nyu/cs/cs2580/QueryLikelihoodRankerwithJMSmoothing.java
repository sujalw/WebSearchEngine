	  ...
	  public ScoredDocument runquery(String query, int did){
	    ...
	    double score = 0.0;
	      for (int i = 0; i < qv.size(); ++i){
	    	  ...
	    	  System.out.println("query :"+qv.get(i));
	    	  System.out.println("lambda :"+lambda);
	    	  System.out.println("fqid :"+ ranker.getFrequid(qv.get(i),did));
	    	  System.out.println("|D| :"+ranker.getTotalNumberOfWordsInaDocument(did));
	    	  System.out.println("cqi :"+ ranker.termFrequency(qv.get(i)));
	    	  System.out.println("|C| :"+ ranker.termFrequency());*/
	    	  
	          score += Math.log((1-lambda)*(ranker.getQueryLikelihood(qv.get(i), did))+
	        		  (lambda)*(ranker.termFrequency(qv.get(i))/ranker.termFrequency()));
	      }
